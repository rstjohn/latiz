...
import com.AandR.palette.plugin.hud.IShowHudPanel;
 ...
 * @author rstjohn
 */
public class ShowHudPanelImpl implements IShowHudPanel {
    public void showHudPanel(AbstractPlugin plugin) {
        ...
        if (hudContainer == null) {
            ...
            hudContainer.setDisplayName(plugin.getName());
            hudContainer.setToolTipText(hudContainer.getName());
        }
        if (!hudContainer.isOpened()) {
            hudContainer.open();
        }
        hudContainer.requestActive();
    }
}

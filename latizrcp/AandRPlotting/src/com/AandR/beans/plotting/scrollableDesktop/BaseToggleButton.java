 ...
 * {@link com.AandR.gui.scrollableDesktop.BaseInternalFrame BaseInternalFrame}
...
public class BaseToggleButton extends JToggleButton implements DesktopConstants, FrameAccessorInterface {
  ...
  private void setButtonFormat() {
    ...
    setFont(new Font(buttonFont.getFontName(), buttonFont.getStyle(), buttonFont.getSize() - 1));
   ...
   * {@link 
   * com.AandR.gui.scrollableDesktop.DesktopConstants#CONTENTS_CHANGED_COLOR

...
/**
 * This class provides a custom desktop pane. The drag mode is set to {@link javax.swing.JDesktopPane#OUTLINE_DRAG_MODE outline} by default, the
 * desktop manager is set to {@link com.AandR.gui.scrollableDesktop.BaseDesktopManager  BaseDesktopManager}, and the look and feel DesktopIconUI is
 * replaced by the blank icon generator, {@link com.AandR.gui.scrollableDesktop.EmptyDesktopIconUI EmptyDesktopIconUI}.
 * 
...
// replace the following line with the above to execute under JDK 1.2
  ...
  /**
   * returns the view rectangle associated with the {@link com.AandR.gui.scrollableDesktop.DesktopScrollPane DesktopScrollPane} viewport
   * 
  ...
  /**
   * propogates the removeAssociatedComponents() call to {@link com.AandR.gui.scrollableDesktop.DesktopScrollPane DesktopScrollPane}
   * 
   * @param f
   *            the internal frame whose associated components are to be removed
   */
  ...
  /**
   * propogates the resizeDesktop() call to {@link com.AandR.gui.scrollableDesktop.DesktopScrollPane DesktopScrollPane}
   */

 ...
 * {@link com.AandR.gui.scrollableDesktop.DesktopMenu DesktopMenu}.
 *
...
public class ConstructWindowMenu implements ActionListener {
  ...
  private void constructMenuItems(JMenu sourceMenu, boolean tileMode) {
    ...
    JRadioButtonMenuItem radioItem = new BaseRadioButtonMenuItem(this, "Tile", KeyEvent.VK_T, -1, tileMode);
    autoMenu.add(radioItem);
    autoMenuGroup.add(radioItem);

    radioItem = new BaseRadioButtonMenuItem(this, "Cascade", KeyEvent.VK_C, -1, !tileMode);
    autoMenu.add(radioItem);
    autoMenuGroup.add(radioItem);
    ...
    sourceMenu.add(new BaseMenuItem(this, "Close", KeyEvent.VK_S, KeyEvent.VK_Z));
    sourceMenu.addSeparator();
  }

...
/**
 * This class provides a custom internal frame. Each internal frame is assigned an associated toggle button and an optional radio button menu item.
 * These buttons reside in the {@link com.AandR.gui.scrollableDesktop.DesktopResizableToolBar  DesktopResizableToolBar} and
 * {@link com.AandR.gui.scrollableDesktop.DesktopMenu DesktopMenu}. classes respectively.
 * 
...
public class BaseInternalFrame extends JInternalFrame {
  ...
  /**
   * returns the initial dimensions of this internal frame. Necessary so that internal frames can be restored to their default sizes when the cascade
   * frame positioning mode is chosen in {@link com.AandR.gui.scrollableDesktop.FramePositioning FramePositioning}.
   * 
  ...
  /**
   * saves the size of the current internal frame for those frames whose initial width and heights have not been set. Called when the internal frame
   * is added to the JDesktopPane. <BR>
   * <BR>

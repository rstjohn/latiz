 ...
 *
 */
public class IntegerValueDocumentListener implements DocumentListener, KeyListener, FocusListener {

    protected Color defaultColor;
    protected JTextField field;
    private String previousValue;

    public IntegerValueDocumentListener() {
    }

    public IntegerValueDocumentListener(JTextField field) {
        decorate(field);
    }

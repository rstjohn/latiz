 ...
 */
public class JButtonWithDropSupport extends JButton implements DropTargetListener, Serializable {
   ...
   * 
   */
  public JButtonWithDropSupport() {
    super();
    if(!GraphicsEnvironment.isHeadless())
      new DropTarget(this, this);
  }
  
  public JButtonWithDropSupport(ImageIcon icon) {
    super(icon);
    if(!GraphicsEnvironment.isHeadless())
      new DropTarget(this, this);
  }
  
  public JButtonWithDropSupport(String label) {
    super(label);
    if(!GraphicsEnvironment.isHeadless())
      new DropTarget(this, this);
  }
  
  public JButtonWithDropSupport(String label, ImageIcon icon) {
    super(label, icon);
    if(!GraphicsEnvironment.isHeadless())
      new DropTarget(this, this);
  }

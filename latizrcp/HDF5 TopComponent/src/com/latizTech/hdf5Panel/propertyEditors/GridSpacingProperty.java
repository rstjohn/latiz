 ...
 * @author rstjohn
 */
public class GridSpacingProperty extends PropertySupport.ReadOnly<Double[]> {

    private double[] gridSpacing;

    public GridSpacingProperty(double[] gridSpacing) {
        super("GridSpacing", Double[].class, "GridSpacing", "Grid-point spacing");

...
/*
 * Token.java - Generic token Copyright (C) 1998, 1999 Slava Pestov You may use and modify this package for any purpose. Redistribution is permitted, in both source and binary form, provided that this
 * notice remains intact in all source distributions of this package.
 */
/**
 * A linked list of tokens. Each token has three fields - a token identifier, which is a byte value that can be looked up in the array returned by <code>SyntaxDocument.getColors()</code> to get a
 * color value, a length value which is the length of the token in the text, and a pointer to the next token in the list.
 * @author Slava Pestov
 * @version $Id: Token.java,v 1.1 2007/05/25 00:12:29 stjohnr Exp $
 */
public class Token {
    ...
    public static final byte COMMENT3 = 20;
    public static final byte COMMENT4 = 22;
    public static final byte COMMENT5 = 23;
    /**
    ...
    public static final byte LITERAL3 = 21;
    /**
    ...
    public static final byte KEYWORD4 = 24;
    /**
    ...
    public static final byte ECLIPSE_PACKAGE = 11;
    public static final byte ECLIPSE_STRINGS = 12;
    /**
     * The total number of defined token ids.
     */
    public static final byte ID_COUNT = 25;
    /**

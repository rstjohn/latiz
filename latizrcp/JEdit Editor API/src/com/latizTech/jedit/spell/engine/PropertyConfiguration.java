...
*/
package com.latizTech.jedit.spell.engine;
...
public class PropertyConfiguration extends Configuration {
  ...
  public PropertyConfiguration() {
    prop = new Properties();
    try {
      filename = getClass().getClassLoader().getResource("com/AandR/beans/jEditPanel/spell/engine/configuration.properties");
  ...
  /**
   * @see com.AandR.beans.jEditPanel.spell.engine.Configuration#getBoolean(String)
   */
  ...
  /**
   * @see com.AandR.beans.jEditPanel.spell.engine.Configuration#getInteger(String)
   */
  ...
  /**
   * @see com.AandR.beans.jEditPanel.spell.engine.Configuration#setBoolean(String, boolean)
   */
  ...
  /**
   * @see com.AandR.beans.jEditPanel.spell.engine.Configuration#setInteger(String, int)
   */

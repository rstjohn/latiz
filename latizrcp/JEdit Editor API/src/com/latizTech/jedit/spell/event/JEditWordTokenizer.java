...
*/
package com.latizTech.jedit.spell.event;

import com.latizTech.jedit.JEditPanel;
import com.latizTech.jedit.JEditTextArea;
 ...
 */
public class JEditWordTokenizer implements WordTokenizer {
   ...
   */
  public JEditWordTokenizer(JEditPanel textEditorPanel) {
    JEditTextArea textArea = textEditorPanel.getTextArea();
    ...
    this.document = textEditorPanel.getTextArea().getDocument();
    createTextSegment(textEditorPanel.getTextArea());
  }

  private void createTextSegment(JEditTextArea textArea) {
    text = new Segment();
    ...
    try {
      ...
      currentWordPos = getNextWordStart(text, start);

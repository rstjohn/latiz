...
//  private JEditTextArea textArea;
  ...
  public DocumentWordTokenizer(JEditPanel textEditorPanel) {
    this(textEditorPanel.getTextArea().getDocument());
//    this.textArea = textEditorPanel.getTextArea();
  }
  ...
  protected void createTextSegment(int cursorLoc) {
    text = new Segment();
    sentenceIterator = BreakIterator.getSentenceInstance();
    try {
      document.getText(cursorLoc, document.getLength(), text);

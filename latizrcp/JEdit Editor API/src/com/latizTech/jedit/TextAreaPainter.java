 ...
 * 
 * You may use and modify this package for any purpose. Redistribution is permitted, in both source and binary form, provided that this notice remains
 ...
 * 
 * @author Slava Pestov
 * @version $Id: TextAreaPainter.java,v 1.2 2007/08/23 02:01:48 stjohnr Exp $
 */
public class TextAreaPainter extends JComponent implements TabExpander {
    ...
    /**
     * Returns true if bracket highlighting is enabled, false otherwise. When bracket highlighting is enabled, the bracket matching the one before the
    ...
    /**
     * Enables or disables bracket highlighting. When bracket highlighting is enabled, the bracket matching the one before the caret (if any) is
     * highlighted.
     *
    ...
    public interface Highlight {
        ...
        /**
         * Returns the tool tip to display at the specified location. If this highlighter doesn't know what to display, it should delegate to the next
         * highlight painter.
         *
         * @param evt
         *            The mouse event

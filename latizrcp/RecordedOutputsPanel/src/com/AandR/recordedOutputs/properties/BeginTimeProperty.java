 ...
 * @author Aaron Masino
 */
public class BeginTimeProperty extends PropertySupport.ReadWrite<Double> {

    private OutputDataObject outputData;

    public BeginTimeProperty() {
        super("Begin Time", Double.class, "Begin Time", "Creates a variable alias");
    }

    public BeginTimeProperty(OutputDataObject variable) {
        this();
        this.outputData = variable;
    }

    public Double getValue() throws IllegalAccessException, InvocationTargetException {
        return outputData.getBeginTime();
    }

    @Override
    public void setValue(Double value) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        outputData.setBeginTime(value);
    }
}

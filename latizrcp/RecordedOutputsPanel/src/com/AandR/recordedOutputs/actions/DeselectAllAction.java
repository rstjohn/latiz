 ...
 *
 */
public class DeselectAllAction extends AbstractAction implements Presenter.Popup {

    private final AbstractNode pluginNode;

    public DeselectAllAction(AbstractNode pluginNode) {
    ...
    public void actionPerformed(ActionEvent e) {
        for (Node node : pluginNode.getChildren().getNodes()) {
            ...
            outputNode.getOutputData().setSelected(false);
        }
    }

    public JMenuItem getPopupPresenter() {
        JMenuItem item = new JMenuItem("Deselect All");

 ...
 * @author rstjohn
 */
public class PluginNameChangeImpl implements IPluginNameChange {
    public void nameWillChange(PaletteScene scene, AbstractPlugin p, String oldName, String newName) {
//        RecordedOutputsTopComponent rotc = RecordedOutputsTopComponent.findInstance();
//        rotc.pluginNameWillChange(scene, p, oldName, newName);
    }

    public void nameChanged(PaletteScene scene, AbstractPlugin p, String oldName, String newName) {
//        RecordedOutputsTopComponent rotc = RecordedOutputsTopComponent.findInstance();
//        rotc.pluginNameChanged(scene, p, oldName, newName);
    }
}
